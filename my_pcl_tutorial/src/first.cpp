...
/*
    ...
    <rotation of y axis>
    transform_1 (0,0) = std::cos (theta_r90);
    ...
    transform_1 (1,0) = std::sin (theta_r);
...
int main(int argc, char** argv)
{
	...
	ros::NodeHandle nh;
	ros::Subscriber sub = nh.subscribe<sensor_msgs::PointCloud2> ("vlp_1/velodyne_points", 100, input);
...
// also the ring data that you have to use is from the lio_sam, image projection.cpp s